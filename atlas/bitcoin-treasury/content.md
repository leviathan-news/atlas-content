...
By August 2026 Metaplanet was funding that accumulation from two new directions at once. On August 13 it [completed the inaugural issuance](https://www.tftc.io/metaplanet-bitbonds-japan-yen-bond-bitcoin-treasury) of "BitBonds" — ¥200 million (about $1.3 million) in three-year notes carrying 4.0–4.3% coupons, sold through its own Metaplanet Securities subsidiary. The notes are unsecured: no Bitcoin backs them, so bondholders carry Metaplanet's credit risk rather than a claim on its treasury. Five days later the company went further, agreeing to contribute 2,100 BTC (about $132 million) for roughly 95.7% of [Nasdaq-listed Super League](https://ir.superleague.com/news-events/press-releases/detail/304/metaplanet-to-invest-2100-bitcoin-in-super-league-to), which will be renamed Superplanet and become its dedicated US treasury vehicle once the deal closes in the fourth quarter of 2026. "We've built one of the world's largest Bitcoin treasuries from Japan," said chief executive Simon Gerovich. "Superplanet is how we build in America, the deepest capital market in the world." Between the two moves, Metaplanet now has a debt-funded lever alongside the equity issuance that built its original position, plus a second listed vehicle raising capital in a different currency and market entirely.
...
By August 2026 the pure-play thesis was already straining under its own numbers. Twenty One [posted a $413.5 million second-quarter net loss](https://www.theblock.co/news/business/2026-08-11-twenty-one-capital-414-million-q2-loss-new-ceo-plots-path-bitcoin-treasury-411432), mostly the mark on its 43,514 BTC treasury as Bitcoin's price fell, and had just swapped founding CEO Jack Mallers — who stepped back to run his separate payments company, Strike — for Raphael Zagury. Zagury's diagnosis doubled as an indictment of the pure-treasury model: the stock traded at 0.7x its enterprise mNAV rather than the premium the structure depends on, and in his words, "that gap could be viewed as a misallocation of capital; we share that view." His answer was to stop being only a Bitcoin balance sheet — layering governance changes, acquired operating businesses, capital-markets work, M&A, and Bitcoin-backed lending on top of the treasury, with Berkshire Hathaway as the explicit template, because, as he put it, "if Twenty One is going to be worth owning, it must become more than a Bitcoin treasury." The second-largest public Bitcoin treasury, in other words, now argues its own survival depends on becoming something other than a treasury.
...
Twenty One Capital is the live counter-example to that mechanism. By August 2026 it traded at [0.7x its enterprise mNAV](https://www.theblock.co/news/business/2026-08-11-twenty-one-capital-414-million-q2-loss-new-ceo-plots-path-bitcoin-treasury-411432) — a discount, not a premium — while its income statement showed a related but distinct symptom: a $413.5 million second-quarter net loss, mostly the accounting mark on its 43,514 BTC treasury as Bitcoin's price fell. The two figures measure different things — mNAV is what the market pays for a dollar of the company's Bitcoin, the net loss is an accounting result on Bitcoin it already owns — but together they show the flywheel running backward. A company trading below its Bitcoin value can no longer issue equity at a premium to buy more BTC; it can only dilute existing holders to raise cash at all, the opposite of the loop that built Strategy's position.
