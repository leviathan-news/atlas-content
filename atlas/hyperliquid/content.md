...
That tailored-rules framing escalated sharply on August 19, when President Trump, addressing a White House gathering of crypto executives and regulators that included Selig and SEC Chair Paul Atkins, said ["I understand that Mike is also working to bring Hyperliquid into the United States in a fully compliant and legal fashion, working very hard on that,"](https://thedefiant.io/news/regulation/trump-says-cftc-working-to-onshore-hyperliquid) and HYPE rallied sharply over the following day, though reported figures for the move varied widely—a reaction to a remark that, on its own, committed the agency to nothing specific.

The next day, Selig gave the line teeth at the CFTC's inaugural Innovation Advisory Committee meeting, telling attendees that if the CLARITY Act keeps stalling in Congress, ["the CFTC will utilize its existing authorities to begin establishing a regime for crypto asset markets,"](https://www.coindesk.com/policy/2026/08/20/u-s-cftc-chief-puts-staff-on-notice-to-create-crypto-regulations-if-clarity-act-fails) directing staff toward a new designated-contract-market category built for leveraged on-chain trading and toward working directly with on-chain protocol developers on legal paths into the U.S. What that push doesn't yet resolve is who is accountable when the protocol itself is permissionless: [registered-operator identity, where KYC happens—interface, broker, or wallet—and how stablecoin collateral gets custodied and cleared are all still open questions](https://cryptoslate.com/trumps-hyperliquid-push-forces-regulators-to-define-what-a-legal-on-chain-exchange-looks-like/), unresolved by either the White House remark or the staff directive. A presidential name-check and a staff directive are not a registration; as of this writing [no Hyperliquid entity has filed an application and no CFTC timeline has been set](https://finance.yahoo.com/markets/crypto/articles/trump-says-cftc-working-bring-192558411.html), and incumbent regulated venues such as CME Group and ICE are the ones most exposed if on-chain platforms like Hyperliquid get a clear path onshore.
...
Hyperliquid enters the second half of 2026 at an inflection point. Open interest at $10 billion, HYPE ETF volumes approaching $900 million, and a president publicly crediting the CFTC chair with working to bring the platform onshore all suggest the platform is transitioning from a DeFi novelty to a serious piece of market infrastructure.
...
Portfolio margining improvements, SPX and SPCX options, and growing integrations via Near and Infinex point to a roadmap aimed at feature parity with sophisticated centralized derivatives venues, while retaining the on-chain transparency that neither Binance nor the CME can offer. The regulatory variable has tilted toward accommodation rather than confrontation: a sitting president naming the platform from the White House, followed within a day by a CFTC chair directing staff toward a bespoke on-chain designation, is a different order of signal than a podcast remark. But a signal is not a rulebook—the accountability, KYC, and custody questions Selig's own staff are still working through are exactly the ones that will decide whether Hyperliquid can operate for U.S. users at all, and CME and ICE are the incumbent venues with the most to lose if that question resolves in Hyperliquid's favor. For now, Hyperliquid is the strongest evidence yet that a fully on-chain order book can compete at institutional scale, with a regulatory path that looks newly plausible but remains unbuilt.
